...
let isPaused = true;
let matches;
let fails = 0; // Initialize fails to 0
let score = 0;
let highscore = 0;
...
const resetGame = async() => {
    ...
    document.getElementById("fails").innerHTML = "fails: " + fails; // Update fails display
}
...
const clickCard = (e) => {
    ...
    document.getElementById("score").innerHTML = "score: " + score; // Update score display
    document.getElementById("fails").innerHTML = "fails: " + fails; // Update fails display
    document.getElementById("highscore").innerHTML = "highscore: " + highscore; // Update fails display
}
